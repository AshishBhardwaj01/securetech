...
const FrameComponent2 = ({ className = "" }) => {
  ...
  return (
    <section
      className={`relative top-[40vw] xl:top-[850px] lg:top-[1500px] w-full flex-col items-center justify-start lg:justify-center py-[20px] px-[20px] box-border gap-[100px] max-w-full text-center text-51xl text-black font-poppins ${className}`}
    >
