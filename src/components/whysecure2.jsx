...
const VenueSpacesContainer = ({ className = "" }) => {
  return (
                        <section className={`relative top-[26vw] xl:top-[700px] lg:hidden lg:top-[1100px] left-0 px-10 md:w-[70vmin] flex flex-col items-center justify-start gap-[6vh] max-w-full text-center md:text-left text-[6vw] md:text-[15vmax] text-black font-poppins ${className}`}>

                          <div className="self-stretch flex flex-row items-center justify-center py-0  box-border max-w-full text-center">
                            <div className="flex-1 flex flex-col items-center justify-center gap-14 lg:gap-[10px] max-w-full">
                            <div className="w-full flex flex-row items-center justify-center px-[2.5rem] box-border">
              ...
              <div className="flex-1 relative leading-[1.875rem] text-gray-200 inline-block max-w-full">
                <p className="text-base sm:text-xs md:text-lg lg:text-[1rem] lg:leading-[0.9rem] xl:text-lg">
                  ...
                  cutting-edge solutions.
                          ...
                          >
                            <div className="flex-1 flex flex-col items-start justify-start min-w-[287px] max-w-full text-right mq1350:flex-1">
                      <div className="self-stretch flex flex-col items-end justify-end pt-0 pb-[30.5px] box-border gap-[9.5px] max-w-full">
                        ...
                        <div className="relative text-base leading-[26px]">
                          <p className="m-0">
                            With over a decade and a half of industry expertise,we've developed best practices through hands-on work, assisting diverse businesses.through hands-on work, assisting diverse businesses.
                          </p>
