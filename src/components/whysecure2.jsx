...
const VenueSpacesContainer = ({ className = "" }) => {
  return (
                        <section className={`relative lg:hidden  left-0 px-10 md:w-[70vmin] flex flex-col py-20 items-center justify-start gap-[6vh] max-w-full text-center md:text-left text-[6vw] md:text-[15vmax] text-black font-poppins ${className}`}>
