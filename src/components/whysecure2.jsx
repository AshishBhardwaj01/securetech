...
const VenueSpacesContainer = ({ className = "" }) => {
  return (
    <section className={`relative top-[2850px] lg:top-[700px] left-0 px-10 w-[90vw] md:w-[70vmin] flex flex-col items-center justify-start gap-[6vh] max-w-full text-center md:text-left text-[6vw] md:text-[15vmax] text-black font-poppins ${className}`}>
