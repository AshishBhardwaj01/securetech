...
const VenueSpacesContainer = ({ className = "" }) => {
  return (
    <section
      className={`relative top-[26vw] xl:top-[700px] lg:hidden lg:top-[1100px] left-0 px-10 md:w-[70vmin] flex flex-col items-center justify-start gap-[6vh] max-w-full text-center md:text-left text-[6vw] md:text-[15vmax] text-black font-poppins ${className}`}
    >
                ...
                <div className="self-stretch flex flex-col items-end justify-end pt-0 pb-[30.5px] box-border gap-[9.5px] max-w-full">
                  ...
                  <div className="relative text-base leading-[26px]">
                    <p className="m-0">
                      ...
                      diverse businesses.through hands-on work, assisting
                      diverse businesses.
                    </p>
                  </div>
                </div>
