...
const Contactsolution = ({ className = "" }) => {
  return (
    <div
      className={`flex flex-row gap-x-96 py-32 h-auto w-full items-center justify-center shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)] text-lg text-black font-poppins ${className}`}
    >
      <div className=" flex flex-col items-start mb-11 px-10 py-10 rounded-2xl shadow-2xl ">
        ...
        <div className="relative flex flex-row  items-center gap-3">
          <div className="p-4 border border-gray-500 rounded">
            <span className="text-base leading-[27px]">
              info@securetech.com
            </span>
          </div>
          <div className="p-4 border border-gray-500 rounded">
