...
const Contactsolution = ({ className = "" }) => {
  return (
    <div
      className={`flex flex-row lg:flex-col gap-x-96 lg:gap-10 py-32 lg:py-20 h-auto w-full items-center justify-center shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)] text-lg text-black font-poppins ${className}`}
    >
      ...
      <div className="border-gray-1500 flex flex-col items-start justify-start lg:items-center lg:justify-center gap-6 lg:gap-0 text-base">
        <div className="flex flex-row gap-20 lg:gap-5 lg:text-sm  text-base">
