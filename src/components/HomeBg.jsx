...
const HeroContent = ({ className = "" }) => {
  return (
    <div
      className={`relative flex flex-col contrast-125 w-screen h-screen items-start lg:items-center lg:justify-center justify-start py-10 md:py-5 lg:px-2 bg-[url('/Banner.gif')] bg-cover bg-no-repeat bg-top text-left lg:text-center font-poppins ${className}`}
    >
