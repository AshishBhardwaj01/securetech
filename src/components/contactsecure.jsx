...
const FrameComponent = ({ className = "" }) => {
  return (
    <section
      className={`relative top-[33vw] xl:top-[500.2px] lg:top-[700.2px] w-full flex flex-col items-center justify-center gap-10 p-10 box-border text-center text-5xl text-darkslategray-200 font-sans lg:flex-col ${className}`}
    >
        ...
        <div className="flex-1 flex flex-col text-left items-center justify-start gap-1  text-gray-400 font-poppins">
          ...
          <div className="flex flex-col items-start justify-center gap-10">
            <h2 className="text-black items-center justify-center font-medium text-1vh leading-tight text-base">
              ...
              <p className="text-base">and ongoing support.</p>
            </h2>
