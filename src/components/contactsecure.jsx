...
const FrameComponent = ({ className = "" }) => {
  return (
    <section className={`relative top-[35vw] xl:top-[500.2px] lg:top-[700.2px] w-full flex flex-col items-center justify-center gap-10 p-10 box-border text-center text-5xl text-darkslategray-200 font-sans lg:flex-col ${className}`}>
