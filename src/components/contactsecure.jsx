...
const FrameComponent = ({ className = "" }) => {
  return (
    <section className={`relative top-[1700.2px] xl:top-[800.2px] lg:top-[700.2px] w-full flex flex-col items-center justify-center gap-10 p-10 box-border text-center text-5xl text-darkslategray-200 font-sans lg:flex-col ${className}`}>
      <div className="flex flex-row items-start justify-end gap-5 lg:flex-col lg:items-center lg:justify-center lg:gap-5">
        <div className="flex flex-col items-center justify-center gap-5 lg:items-center lg:justify-center lg:gap-5">
        ...
        <div className="flex-1 flex flex-col items-start justify-start gap-5 text-center text-gray-400 font-sans lg:text-xs xl:text-lg 2xl:text-sm ">
