...
const Venue = ({ className = "" }) => {
  ...
  return (
    <section
      className={`relative top-[20vw] xl:top-[500px] lg:top-[900px] left-1/2 transform -translate-x-1/2 w-full flex flex-col items-center justify-center gap-14 text-left text-51xl text-black font-poppins ${className}`}
    >
            ...
            {slides.map((slide, index) => (
              ...
              >
                ...
                <div className="w-full text-center py-2 flex items-center justify-center h-16">
                  <p className="text-black font-medium text-lg-5 md:text-5xl">
                    {slide.text}
                  </p>
                </div>
              </div>
